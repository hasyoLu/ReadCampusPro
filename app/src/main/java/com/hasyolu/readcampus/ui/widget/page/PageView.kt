package com.hasyolu.readcampus.ui.widget.page
...
import com.hasyolu.readcampus.ui.widget.page.anim.*
...
import com.hasyolu.readcampus.ui.widget.page.model.PageMode
...
class PageView @JvmOverloads constructor(
    ...
    //点击监听
    private var mOnTouchListener: com.hasyolu.readcampus.ui.widget.page.event.OnTouchListener? = null
     ...
     * 设置触摸事件
     */
    fun setTouchListener(mOnTouchListener: com.hasyolu.readcampus.ui.widget.page.event.OnTouchListener?) {
